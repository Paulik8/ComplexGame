...
PingWindow::PingWindow(QWidget* parent) : QMainWindow(parent), ui(new Ui::PingWindow), Score(0) {
  ...
  QSize(scene->sceneRect().size().width() + 10,
        scene->sceneRect().size().height() + 10);//задание размеров игрового окна
